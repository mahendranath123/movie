<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wish.aspx.cs" Inherits="Mevie2.wish" %>
            ...
            <asp:DataList ID="DataListWishlist" runat="server" RepeatDirection="Horizontal" OnItemCommand="DataListWishlist_ItemCommand" DataSourceID="SqlDataSourceWishlist">
                <ItemTemplate>
                    <div class="wishlist-item">
                        ...
                        <br /><br />
                        <asp:Button ID="ButtonRemove" runat="server" Text="Remove" CommandName="remove" CommandArgument='<%# Eval("WishlistID") %>' CssClass="btn-remove" OnClick="ButtonRemove_Click" />
                    </div>
                </ItemTemplate>
            </asp:DataList>
            <asp:SqlDataSource ID="SqlDataSourceWishlist" runat="server" 
                ConnectionString="<%$ ConnectionStrings:projectConnectionString9 %>" 
                SelectCommand="SELECT * FROM [Wishlist2] WHERE ([MovieID] = @MovieID)" OnSelecting="SqlDataSourceWishlist_Selecting">
                <SelectParameters>
                    <asp:QueryStringParameter Name="MovieID" QueryStringField="nm" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
