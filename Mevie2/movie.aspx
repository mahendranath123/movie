<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="movie.aspx.cs" Inherits="Mevie2.movie" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString %>" SelectCommand="SELECT * FROM [Movies]" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
        </div>
             <footer class="footer">
