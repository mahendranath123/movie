<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sportview.aspx.cs" Inherits="Mevie2.sportview" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sports Event Details</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString8 %>" SelectCommand="SELECT * FROM [sport_EVENT] WHERE ([eventName] = @eventName)">
                <SelectParameters>
