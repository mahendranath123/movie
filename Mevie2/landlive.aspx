<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="landlive.aspx.cs" Inherits="Mevie2.landlive" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <ItemTemplate>
                    <div class="movie-item">
                        ...
                        <div class="movie-title">
                            EventName: <asp:Label ID="Label1" runat="server" Text='<%# Eval("eventName") %>'></asp:Label>
                        </div>
                        <div class="movie-details">
                            Release Date: <asp:Label ID="Label2" runat="server" Text='<%# Eval("ReleaseDate") %>'></asp:Label>
                        </div>
                        <div class="movie-details">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString6 %>" SelectCommand="SELECT * FROM [LIVE_EVENT] WHERE ([eventName] = @eventName)">
            <SelectParameters>
