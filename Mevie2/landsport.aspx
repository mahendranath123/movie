<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="landsport.aspx.cs" Inherits="Mevie2.landsport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString4 %>" SelectCommand="SELECT * FROM [sport_EVENT] WHERE ([eventName] = @eventName)">
            <SelectParameters>
